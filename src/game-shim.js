...
(function (global) {
  ...
  (function () {
    ...
    window.cancelAnimationFrame =
      window.cancelAnimationFrame || window.cancelRequestAnimationFrame; // Check for older syntax
  ...
  if (!document.hasOwnProperty("fullscreenEnabled")) {
    getter = (function () {
      ...
      return function () {
        return false;
      }; // not supported, never fullscreen
    })();
  ...
  if (!window.performance.now) {
    window.performance.now = (function () {
      ...
      return function () {
        // not supported, return a low-resolution approximation
