define(function (require, exports, module) {
  ...
  scene.Camera.prototype = extend({}, scene.Node.prototype, {
    ...
    getProjection: function (graph) {
      return mat4.perspective(
        this.fov,
        graph.viewportWidth / graph.viewportHeight,
        this.near,
        this.far
      );
    },
  ...
  scene.Mirror.prototype = extend({}, scene.Node.prototype, {
    enter: function (graph) {
      ...
      p[3] = w;
      graph.uniforms.worldView = mat4.multiply(
        graph.uniforms.worldView,
        this._worldView,
        this._worldView_
      );
      ...
      graph.uniforms.worldViewProjection = mat4.multiply(
        projection,
        this._worldView_,
        this._worldViewProjection
      );
      graph.uniforms.projection = projection;
    },
    exit: function (graph) {
